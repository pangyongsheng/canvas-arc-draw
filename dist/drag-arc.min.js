    ...
    createClass(DragAcr, [{
      ...
      value: function initParam(param) {
        var el = param.el,
            ...
            endDeg = _param$endDeg === void 0 ? 1.8 : _param$endDeg,
            _param$innerColor = param.innerColor,
            innerColor = _param$innerColor === void 0 ? "#0078b4" : _param$innerColor,
      ...
      value: function initCanvas(dom) {
        ...
        this.isMobile = /Android|webOS|iPhone|iPod|BlackBerry/i.test(navigator.userAgent); //console.log(this.ctx)
      } //绘图
      ...
      value: function draw(value) {
        ...
        this.ctx.stroke();
        var Deg = this.valToDeg(value); //console.log(Deg)
        // 绘制可变圆弧
      ...
      value: function OnMouseDown(evt) {
        ...
        var X = this.getx(evt);
        var Y = this.gety(evt);
        var P = this.P; // console.log(P)
        // console.log(X,Y)

        var minX = P.x - this.slider;
        var maxX = P.x + this.slider;
        var minY = P.y - this.slider;
        var maxY = P.y + this.slider;
