	  ...
	  _createClass(DragAcr, [{
	    ...
	    value: function event(dom) {
	      ...
	      if (this.isMobile) {
	        ...
	        dom.addEventListener("touchmove", this.debounce(bind$2(_context5 = this.OnMouseMove).call(_context5, this)), false);
	      ...
	      dom.addEventListener("mousemove", this.debounce(bind$2(_context8 = this.OnMouseMove).call(_context8, this)), false);
